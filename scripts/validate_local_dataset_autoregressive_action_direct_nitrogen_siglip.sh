#!/bin/bash
# 自回归验证脚本（nitrogen_siglip direct action）
...
LOG_FILE="${LOG_DIR}/validate_ar_action_direct_nitrogen_siglip_${TIMESTAMP}.log"
...
CHECKPOINT_PATH="output/policy_model/150M_nitrogen_cuphead_future_action_direct_siglip_F5_onelevel1"
N_SEQUENCES=225
GPU_ID="0"
...
usage() {
    echo "用法: bash scripts/validate_local_dataset_autoregressive_action_direct_nitrogen_siglip.sh [选项]"
    echo
    echo "参数:"
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}Nitrogen SigLIP AR Direct Action 验证脚本${NC}"
echo -e "${GREEN}========================================${NC}"
...
export TORCHINDUCTOR_CACHE_DIR=".elefant_temp_ar_direct_siglip_validation/torch_compiler/inductor_cache"
